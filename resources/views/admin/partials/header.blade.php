...
=======
  ...
  <!-- Sidebar toggle button--><a 
    class=" app-sidebar__toggle fas fa-list"
    href="#"
    data-toggle="sidebar"
                ...
                <div class="app-notification__content">
                    <li>
                        <a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span
                                    class="fa-stack fa-lg"><i class="fas fa-circle fa-stack-2x text-primary"></i><i
                    ...
                    <li>
                        <a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span
                                    class="fa-stack fa-lg"><i class="fas fa-circle fa-stack-2x text-danger"></i><i
                                        class="fas fa-hdd fa-stack-1x fa-inverse"></i></span></span>
                            <div>
                                <p class="app-notification__message">
                    ...
                    <li>
                        <a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span
                                    class="fa-stack fa-lg"><i class="fas fa-circle fa-stack-2x text-success"></i><i
                                        class="far fa-money-bill-alt fa-stack-1x fa-inverse"></i></span></span>
                            <div>
                                <p class="app-notification__message">
